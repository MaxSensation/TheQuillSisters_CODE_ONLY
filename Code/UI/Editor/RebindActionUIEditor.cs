...
namespace UI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        {
            m_TutorialProperty = serializedObject.FindProperty("m_isTutorial");
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.PropertyField(m_TutorialProperty);
        ...
        private SerializedProperty m_TutorialProperty;
