...
namespace UI
{
    ...
    {
        /// <summary>
        /// a bool to determine if it's a tutorial or not
        /// </summary>
        ...
        public void UpdateBindingDisplay()
        {
            ...
            if (action != null)
            {
                ...
                if (bindingIndex != -1)
                    displayString = action.GetBindingDisplayString(bindingIndex, out deviceLayoutName,
                        out controlPath, displayStringOptions);
            }
        ...
        private void OnSwitchedDevice(int index)
        {
            var displayString = string.Empty;
            ...
            displayString = action.GetBindingDisplayString(index, out var deviceLayoutName, out var controlPath, displayStringOptions);
        ...
        {
            // action.Disable(); // critical before rebind!!!
            ...
            if (m_RebindText != null)
            {
                var text = !string.IsNullOrEmpty(m_RebindOperation.expectedControlType)
                    ? $"{partName}Waiting for {m_RebindOperation.expectedControlType} input... or press ESC to cancel"
                    : $"{partName}Waiting for input... or press ESC to cancel";
        ...
        protected void OnEnable()
        {
            ...
            if (s_RebindActionUIs.Count == 1 && !m_isTutorial)
                InputSystem.onActionChange += OnActionChange;
            if (m_isTutorial)
            {
                SchemeSwitcher.switchedDevice += OnSwitchedDevice;
            }
        }
        ...
        protected void OnDisable()
        {
            ...
            if (s_RebindActionUIs.Count == 0 && !m_isTutorial)
            {
        ...
        [Tooltip("Bool determining if it's a tutorial \nthis will make it automatic to switch binding")]
        [SerializeField] 
